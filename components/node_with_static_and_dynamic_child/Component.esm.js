...
function create_main_fragment(state, component) {
	var div, div_1, text_1, div_2, text_3, div_3, span, text_5, span_1;
	...
	return {
		c: function create() {
			...
			span_1.textContent = "yar";
			this.h();
		},

		h: function hydrate() {
			div_1.className = "static";
			div_2.className = state.bar;
			span_1.className = state.yar;
			div_3.className = state.baz;
		},
